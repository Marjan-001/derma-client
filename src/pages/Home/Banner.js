...
const Banner = () => {
    return (
        ...
        <section className="relative bg-[url(https://images.pexels.com/photos/5069430/pexels-photo-5069430.jpeg?auto=compress&cs=tinysrgb&w=1440&q=80)] bg-cover bg-center bg-no-repeat" >
            <div className="absolute inset-0 bg-white/66 bg-transparent sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l" >
            </div>
