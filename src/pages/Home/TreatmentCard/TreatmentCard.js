        ...
        <div className="wrapper">
            ...
            <div className="card">
                ...
                <div className="back bg-blue-50 border border-blue-100 shadow-lg shadow-blue-300 text-center py-32 ">
                    ...
                    <h4 className='text-xl font-extrabold text-blue-700'>${price}</h4>
                    <p className='text-lg font-semibold  text-blue-950 mt-2'>{description}</p>
                    <div className='flex items-end justify-center mt-4'>
                        <button className='btn border-none  bg-gradient-to-r from-blue-200 to-blue-300 text-blue-950 font-bold'>Book Appointment</button>
                    </div>
                </div>
            </div>
        </div>
